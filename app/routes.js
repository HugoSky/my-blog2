...
exports.add = function (req, res, next) {
	...
	CommentProxy.add(postId, comment.email, comment.content, function(err, comment){
...
exports.get = function (req, res, next) {
	...
	CommentProxy.total(postId, function(err, comments){
		if(err){
...
exports.delete = function (req, res, next) {
	...
	if(!_id){
		return res.json(jsonTool.object('no comment id'))
	}
